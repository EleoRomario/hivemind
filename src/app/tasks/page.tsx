    ...
    >
      ...
      >
        <div className="flex h-full gap-4">
          ...
          >
            <div className=" flex h-10 w-full cursor-pointer items-center justify-start gap-2 rounded-lg bg-transparent px-3 text-sm text-bunker-400 transition group-hover/new-col:bg-bunker-800 group-hover/new-col:text-bunker-100">
              <Plus />
              Add Column
            </div>
